...
<head>
<title>VIT Hospital Management System</title>
...
<center><a href="index.php"><img src="images/VIT Hospital Management System.png"></a></center>
  <div id="head">
...
{
?>        
        <li><a href="patientappointment.php" <?php if(basename($_SERVER['PHP_SELF']) == "patientappointment.php"){ echo ' class="active"'; } ?>>Appointment</a></li>
